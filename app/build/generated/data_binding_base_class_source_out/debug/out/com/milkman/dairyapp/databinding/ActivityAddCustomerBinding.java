...
public final class ActivityAddCustomerBinding implements ViewBinding {
  ...
  private ActivityAddCustomerBinding(@NonNull LinearLayout rootView,
      @NonNull MaterialButton btnSaveCustomer, @NonNull TextInputEditText etAddress,
      @NonNull TextInputEditText etBuyingPrice, @NonNull TextInputEditText etCustomerName,
  ...
  public static ActivityAddCustomerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAddCustomerBinding((LinearLayout) rootView, btnSaveCustomer, etAddress,
          etBuyingPrice, etCustomerName, etPassword, etPhone, etUsername);
    }
